...
FPSCamera::FPSCamera(unsigned int &screen_width_px, unsigned int &screen_height_px, glm::vec3 start_position,
                     double user_sensitivity, float fov, float zoom_fov, float near_plane, float far_plane)
    : screen_width_px(screen_width_px), screen_height_px(screen_height_px), unscoped_sensitivity(user_sensitivity),
      active_sensitivity(user_sensitivity), mouse(user_sensitivity), original_fov(fov), fov(fov), zoom_fov(zoom_fov),
